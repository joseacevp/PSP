 ...
 * @author josea
 */
public class ServidorHiloCalendario extends Thread{
    
    private Socket sc;

    public ServidorHiloCalendario(Socket sc) {
        this.sc = sc;
    }
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(ServidorHiloCalendario.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                in.close();
                out.close();
